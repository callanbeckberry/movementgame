...
func setup_speech_bubbles():
	...
	# Configure it
	enemy_speech_bubble.set_target(enemy_sprite, Vector2(-50, -200))
	...
	# Configure it
	player_speech_bubble.set_target(player_sprite, Vector2(-50, -200))
...
func _open_attack_menu():
	...
	for i in range(5):
		...
		button.pressed.connect(func(): _execute_player_attack(i))
...
func _start_random_enemy_attack_timer():
	...
	var attack_delay = randf_range(5.0, 20.0)
